        ...
        <ul class="list-group">
            ...
            <li  class="list-group-item">
                <div class="progress">
                    ...
                    <a href="get?r=shop" class="btn btn-secondary btn-lg " role="button" ><!--<img id="refresh" src="./img/refresh.png" alt="refresh">--></a>
                </div>
            </li>
            <li class="list-group-item">
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><span class="badge badge-success"><%=i.getCost()%></span></td>
            <td><span class="badge badge-info"><%=i.getTimesBought()%></span></td>
